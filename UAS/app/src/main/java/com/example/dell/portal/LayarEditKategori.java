...
public class LayarEditKategori extends AppCompatActivity {
    ImageView mPhotoUrl;
    EditText edtIdKategori, edtAddNama;
    TextView tvMessage;
    Context mContext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layar_edit_kategori);
        ...
        edtAddNama.setText(mIntent.getStringExtra("kategori"));
    ...
    private void setListener() {
        ...
        btUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((!pathImage.contains("uploads/" + edtIdKategori.getText().toString())) &&
                        (pathImage.length() > 0)) {
                ...
                Call<GetKategori> callUpdate = mApiInterface.putKategori(body, reqIdKategori, reqNama,
                        reqAction);
                callUpdate.enqueue(new Callback<GetKategori>() {
                    @Override
                ...
                btBack.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent tempIntent = new Intent(mContext, LayarListKategori.class);
