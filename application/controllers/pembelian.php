...
require APPPATH . '/libraries/REST_Controller.php';
    ...
    class pembelian extends REST_Controller{
        ...
        function user_get(){
         ...
         pemb.tanggal_beli, pemb.total_harga, pemb.id_tiket FROM pembeli, pembelian pemb,
          tiket WHERE pemb.id_pembeli=pembeli.id_pembeli AND 
          pemb.id_tiket= tiket.id_tiket") -> result(); 
